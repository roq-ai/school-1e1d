...
export function SchoolListPage(props: SchoolListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getSchools({
        relations: ['user', 'it_staff.count', 'student.count', 'teacher.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('it_staff', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'it_staff',
          header: 'It Staff',
          accessorKey: 'it_staff',
          cell: ({ row: { original: record } }: any) => record?._count?.it_staff,
        }
      : null,
